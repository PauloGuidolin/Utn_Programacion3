    ...
    return (
        <Form className='p-4 border rounded m-3'>
            <Form.Group controlId='formNombre'>
                ...
                <Form.Control type='text' name='nombre' placeholder='ingrese nombre del producto' value={values.nombre}
            ...
            <Form.Group controlId='formImagen'>
                ...
                <Form.Control type='text' name='imagen' placeholder='ingrese imagen' value={values.imagen}
                    onChange={handleChange}>
